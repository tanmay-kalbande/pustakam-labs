...
const MODEL_OPTIONS: { provider: ModelProvider; model: string; name: string }[] = [
    ...
    // LongCat Models
    { provider: 'longcat', model: 'LongCat-Flash-Thinking', name: 'LongCat Flash Thinking' },
    { provider: 'longcat', model: 'LongCat-Flash-Thinking-2601', name: 'LongCat Flash Thinking (2601)' },
    { provider: 'longcat', model: 'LongCat-Flash-Chat', name: 'LongCat Flash Chat' },
    { provider: 'longcat', model: 'LongCat-Flash-Lite', name: 'LongCat Flash Lite' },
];
...
export const TopHeader: React.FC<TopHeaderProps> = ({
    ...
    const isProviderEnabled = (provider: ModelProvider) => {
        switch (provider) {
            ...
            case 'longcat': return !!settings.longcatApiKey;
    ...
    const availableModels = MODEL_OPTIONS.filter(m => {
        ...
        // Strict filtering for Street/Desi modes (Multilingual Giants)
        if (settings.defaultGenerationMode === 'blackhole') {
            const allowedModels = [
                ...
                'LongCat-Flash-Thinking', 'LongCat-Flash-Thinking-2601', 'LongCat-Flash-Chat', 'LongCat-Flash-Lite' // LongCat Models (Street Ready)
            ];
