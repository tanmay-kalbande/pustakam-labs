...
export function SettingsModal({ isOpen, onClose, settings, onSaveSettings, theme, onToggleTheme, onOpenAPIDocs, onOpenUsageGuide, onOpenCompliance, showAlertDialog }: SettingsModalProps) {
  ...
  const apiConfigs = [
    ...
    {
      id: 'longcatApiKey' as keyof APISettings,
      name: 'LongCat AI',
      url: 'https://longcat.chat/settings', // Assumed URL, can be updated later
      description: 'For Flash Thinking, Chat, and Lite models'
    }
  ];
