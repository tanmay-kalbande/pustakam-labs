...
const validProviders: ModelProvider[] = ['cerebras', 'google', 'mistral', 'xai', 'groq', 'openrouter', 'cohere', 'longcat'];
...
const validModels: Record<ModelProvider, ModelID[]> = {
  ...
  longcat: ['LongCat-Flash-Thinking', 'LongCat-Flash-Thinking-2601', 'LongCat-Flash-Chat', 'LongCat-Flash-Lite'],
};
